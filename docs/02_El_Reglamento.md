# Reglamento de los Deberes de la Casa

> Estas son las reglas de la casa. Una vez que los tres las aprobemos, rigen para todos por igual. El admin las hace cumplir y las puede ajustar con el acuerdo de los tres.

---

## Preámbulo · Principios

1. **Los tres deberes principales son sagrados.** Atender a Sofi, cocinar y lavar los platos se cumplen todos los días, sin excepción. Que un obligatorio quede sin hacer es la falta más grave del sistema.
2. **Bienestar de Sofi primero.** Sofi nunca puede quedar sin comida, agua o sus salidas. Esto está por encima de cualquier puntaje.
3. **Igualdad.** Las reglas valen igual para los tres. El admin no es un privilegio, es una responsabilidad, y todas sus acciones quedan a la vista de todos.
4. **Se premia ayudar.** El que ayuda al otro gana más que el que solo cumple lo suyo.

---

## Artículo 1 · Los deberes y cuándo se dan por cumplidos

### 1.1 Atender a Sofi (obligatorio · 10 pts)
Se cumple cuando, en el día:
- Se baja a hacer sus necesidades **mínimo dos veces** (una en la mañana y otra en la noche).
- Se le sirve **comida y agua dos veces** (mañana y noche).
- Se recoge y limpia **cualquier desastre o necesidad** que haga dentro de la casa ese día.

*Se marca con check, sin foto.*

### 1.2 Cocinar (obligatorio · 10 pts)
Se cumple cuando:
- Se cocina para **todos** el almuerzo (el que cada quien se lleva al trabajo o la uni) **y** la cena.
- Se sirve la comida en el **pote de cada integrante**.
- Se deja la **cocina limpia** y todo lo sucio se traslada al lavaplatos.
- Se recoge el material usado y se guarda, de modo que el que lava **solo tenga que lavar**.
- Se recoge y **bota la basura** del día.

*Se marca con check, sin foto.*

### 1.3 Lavar los platos (obligatorio · 10 pts)
Se cumple cuando:
- Se lava **todo** lo utilizado en el día.
- Se **seca** todo lo lavado y se **guarda** en su lugar.
...
### 1.5 extras personales (día por medio, toda la semana · con foto)
...
| Cuarto ordenado | +2.5 | General, Responsable |
| Clóset ordenado | +2.5 | General, Responsable |
...
## Artículo 5 · Reglas de fallo y consecuencias

1. **Fallar tu deber sin una razón válida** te resta **15 puntos**, y ese deber lo tiene que hacer otro para ganarse el bono.
2. **Si un obligatorio no lo hace nadie** (falta máxima): los **tres pierden 10 puntos**, porque es una falla de la casa, no de una sola persona.
3. Las consecuencias se reflejan en los puntos, **nunca en logros negativos**.
...
## Artículo 7 · Validación y confianza
...
## Artículo 8 · El administrador

1. Se accede al modo admin usando una contraseña maestra de la casa. El admin no es una persona específica, sino cualquier participante que ingrese esta contraseña.
...
Al firmar, los tres aceptamos que estas reglas rigen nuestros deberes y que el admin las hace cumplir con transparencia.

- Hermano 1: ______________________
- Hermano 2: ______________________
- Hermano 3: ______________________

_Fecha: _____________________
