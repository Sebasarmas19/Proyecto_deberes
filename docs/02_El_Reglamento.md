...
1. **Los tres deberes principales son sagrados.** Atender a Sofi, cocinar y lavar los platos se cumplen todos los días, sin excepción. Que un no negociable quede sin hacer es la falta más grave del sistema.
...
### 1.1 Atender a Sofi (no negociable · 10 pts)
...
### 1.2 Cocinar (no negociable · 10 pts)
Se cumple cuando:
...
### 1.3 Lavar los platos (no negociable · 10 pts)
Se cumple cuando:
...
|--------|--------|--------|
| Cumplir tu deber no negociable | +10 | General, Confiable |
...
| No negociable que no hizo nadie | −10 a los tres | General (los tres) |
...
2. **Si un no negociable no lo hace nadie** (falta máxima): los **tres pierden 10 puntos**, porque es una falla de la casa, no de una sola persona.
